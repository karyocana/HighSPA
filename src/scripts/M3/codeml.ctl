      seqfile = %=FASTA_FILE%-f.phylip   * sequence data filename
     treefile = RAxML_result.%=FASTA_FILE%.tree      * tree structure file name
      outfile = M3_results.txt   * main result file name
    ...
    CodonFreq = 2      * 0:equal, 1:F1X4, 2:F3X4, 3:F61
      ...
      NSsites = 3      * 0:one omega ratio (M0)
                       * 1:neutral (M1)
                       * 2:selection (M2)
                       * 3:discrete (M3)
                       * 7:beta (M7)
